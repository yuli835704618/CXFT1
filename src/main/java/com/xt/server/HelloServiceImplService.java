 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://impl.service.xt.com/", wsdlLocation = "http://localhost:9999/javaws/getWeather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.xt.com/", "HelloServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/javaws/getWeather?wsdl");
    ...
    public HelloServiceImpl getHelloServiceImplPort() {
        return super.getPort(new QName("http://impl.service.xt.com/", "HelloServiceImplPort"), HelloServiceImpl.class);
    }
    ...
    public HelloServiceImpl getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.xt.com/", "HelloServiceImplPort"), HelloServiceImpl.class, features);
    }
